...
function setupMQ2Gauge() {
  ...
  card.innerHTML = `
    ...
    <div style="position: relative; right: 0; bottom: 10%; width: 95%; margin: auto;">
      <canvas id="mq6GaugeCanvas" style="width: 100%; height: auto;"></canvas>
      <div id="mq6GaugeCenter"
  ...
  const ctx = document.getElementById("mq6GaugeCanvas").getContext("2d");
  ...
  const label = document.getElementById("mq6GaugeCenter");
  onValue(ref(db, "mq6PPM"), snapshot => {
