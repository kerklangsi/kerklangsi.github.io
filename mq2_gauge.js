...
function setupMQ2Gauge() {
  ...
  card.innerHTML = `
    ...
    <div style="position: relative; right: 0; bottom: 10%; width: 95%; margin: auto;">
      <canvas id="mq2GaugeCanvas" style="width: 100%; height: auto;"></canvas>
      <div id="mq2GaugeCenter"
  ...
  const ctx = document.getElementById("mq2GaugeCanvas").getContext("2d");
  ...
  const label = document.getElementById("mq2GaugeCenter");
  onValue(ref(db, "mq2PPM"), snapshot => {
